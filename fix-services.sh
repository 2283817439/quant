...
# 修复 runner-service.ts
cat > webui/server/paperclip-services/runner-service-fixed.ts << 'EOF'
...
mv webui/server/paperclip-services/runner-service-fixed.ts webui/server/paperclip-services/runner-service.ts

echo "Fixed runner-service.ts"